...
const backgroundStyle = {
  ...
  height: "755px",
  boxShadow:
    " inset 5px 10px 5px 400px rgba(0,0,0,0.64), inset 5px 17px 50px 50px rgba(0,0,0,0.64), inset 5px 17px 50px 50px rgba(0,0,0,0.64)",
};
  ...
  return (
    <div style={backgroundStyle} className="border-b-[6px] border-zinc-500">
      <header className="flex w-full px-14 pt-7 items-center justify-between">
        ...
        <Link to="/home">
          <button className="bg-red-700 w-20 h-10 rounded-sm hover:border-2 hover:border-zinc-100 text-zinc-100">
            Entrar
          </button>
        </Link>
      </header>
      <main className="w-auto h-[755px] flex flex-col items-center justify-center text-zinc-100 text-center gap-5 lg:px-96 md:py-20 ">
        <h1 className="font-bold sm:text-lg lg:text-7xl">
